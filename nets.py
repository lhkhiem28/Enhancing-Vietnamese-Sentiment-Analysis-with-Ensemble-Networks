...
class TextCNN(nn.Module):
    def __init__(self, embedding_matrix, n_filters=128, kernel_sizes=[1, 3, 5], featrue_dim=256, dropout_prob=0.2):
        ...
        self.extracter  = nn.Linear(n_filters * len(kernel_sizes), featrue_dim)
...
class LSTMCNN(nn.Module):
    def __init__(self, embedding_matrix, hidden_size=128, featrue_dim=256, dropout_prob=0.2):
        ...
        self.extracter  = nn.Linear(self.hidden_size, featrue_dim)
        self.classifier = nn.Linear(featrue_dim, 1)
